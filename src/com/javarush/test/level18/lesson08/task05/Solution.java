...
public class Solution {
    public class TableInterfaceWrapper implements ATableInterface {
        ...
        private final ATableInterface parent;

        public TableInterfaceWrapper(ATableInterface parent)
        {
            this.parent=parent;
        }
        ...
        public void setModel(List rows)
        {
            ...
            parent.setModel(rows);
        }

        @Override
        public String getHeaderText()
        {
            return parent.getHeaderText().toUpperCase();
        }

        @Override
        public void setHeaderText(String newHeaderText)
        {
            parent.setHeaderText(newHeaderText);
        }
    }
