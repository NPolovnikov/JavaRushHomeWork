...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        while (true)
        {
            ...
            person = PersonFuctory.getPerson(key);
    ...
    static class PersonFuctory
    {
        static Person getPerson(String name){
            Person result = null;

            if (name.equals("user")){
                result = new Person.User();
            }
            if (name.equals("looser")){
                result = new Person.Looser();
            }
            if (name.equals("coder")){
                result = new Person.Coder();
            }
            if (name.equals("proger")){
                result = new Person.Proger();
            }
